...
lyr_Controlled_Parking_Zones_edinbourgh_1.set('fieldImages', {'OBJECTID': '', 'cacz_ref_n': '', 'date_last_': '', 'no_osp_spa': '', 'no_pnr_spa': '', 'no_pub_spa': '', 'no_res_spa': '', 'Zone_No': '', 'Type': '', 'Shapearea': '', 'Shapelen': '', });
lyr_treepreservationzone_2.set('fieldImages', {'feature_id': '', 'reference': '', 'name': '', 'tree_preservation_order': '', 'tree_preservation_zone_type': '', 'uprn': '', 'address_text': '', 'notes': '', 'start_date': '', 'end_date': '', 'entry_date': '', });
lyr_CamdenParkingbays_3.set('fieldImages', {'Restriction Type': '', 'Parking Spaces': '', 'Times Of Operation': '', 'Maximum Stay': '', 'Tariff': '', 'Cashless Identifier': '', 'Nearest Machine': '', 'Road Name': '', 'Postcode': '', 'Controlled Parking Zone': '', 'Valid Parking Permits': '', 'Parking Bay Length Metres': '', 'Disclaimer': '', 'Easting': '', 'Northing': '', 'Longitude': '', 'Latitude': '', 'EPSG:4326 Well Known Text Geometry': '', 'EPSG:27700 GeoJSON Geometry': '', 'EPSG:4326 GeoJSON Geometry': '', 'Unique Identifier': '', 'Spatial Accuracy': '', 'Last Uploaded': '', 'Location': '', 'Organisation URI': '', });
